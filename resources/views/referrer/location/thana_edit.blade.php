            ...
            <div class="col-lg-6">
              <section class="panel">
                ...
                <div class="alert alert-success print-success-msg text-center" style="display: none;"></div>
                    <form id="data_form" action="{{ url('/thana-update') }}" method="post" class="form-inline" role="form">
                      @csrf
                      @foreach ($thana as $thn)
                        ...
                        <div class="control-group">
                          <div class="controls">
                            ...
                            <input type="text" name="thn" value="{{ $thn->thn }}" class="form-control" id="thn" placeholder="Enter Thana Name">
                          </div>
                        </div>
                        <br>
                      @endforeach
