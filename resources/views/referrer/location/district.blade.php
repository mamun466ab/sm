            ...
            <div class="col-lg-6">
              <section class="panel">
                ...
                <div class="alert alert-success print-success-msg text-center" style="display: none;"></div>
                    <form id="data_form" action="{{ url('/district-update') }}" method="post" class="form-inline" role="form">
                      @csrf
                        ...
                        <div class="control-group">
                          <div class="controls">
                            ...
                            <input type="text" name="dst" class="form-control" id="dst" placeholder="Enter District Name">
                          </div>
                        </div>
                        <br>
                        <div class="control-group">
                          <div class="controls">
                            <button type="submit" class="btn btn-success">Add New District</button>
                          </div>
                        </div>
                    </form>
